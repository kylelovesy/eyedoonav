...
sequenceDiagram
    ...
    Repo->>Repo: generateId() for config.id
...
sequenceDiagram
    ...
    Repo->>Repo: generateId() for event.id
...
| `src/utils/id-generator.ts`                                   | ID generation utilities               | `generateId()`                                                        |
